        ...
        <>
          <Box display={'flex'} flexDirection={'row'}>
            ...
            <Box display={'flex'} flexDirection={'column'} width={'40%'}>
                ...
                <Box display={'flex'} flexDirection={'row'}>
                    <Box borderWidth='1px' borderRadius='lg' display={'flex'} justifyContent={'center'}>
                        <Stack direction='row' width={'65%'}>
                            <Wrap spacing={'3'} width={'100%'}>
                                {newMotorLots.map((lot) => (
                                    <WrapItem width={'2vw'} key={lot.lotId}>
                                        <Button colorScheme='red' width={'100%'} height={'3vh'}></Button>
                                    </WrapItem>
                                ))}
                            </Wrap>
                        </Stack>
                        <Box style={{ writingMode: 'vertical-rl' }} bg={'gray.200'}>
                            ZONE
                        </Box>
                    </Box>
                    <Box borderWidth='1px' borderRadius='lg' display={'flex'} justifyContent={'center'}>
